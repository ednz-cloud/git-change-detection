...
- **deps**: update dependency typer to >=0.27.0,<0.28.0

## v0.2.5 (2026-06-05)

### Fix

- **deps**: update dependency typer to >=0.26.7,<0.27.0

## v0.2.4 (2026-04-27)

### Fix

- **deps**: update dependency typer to >=0.25.0,<0.26.0
...
- **deps**: update dependency typer to >=0.24.0,<0.25.0
